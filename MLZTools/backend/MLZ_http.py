...
import PluginUtils
from MLZ_config import HTTP_TIMEOUT_DEFAULT, USER_AGENT
...
BASE_HEADERS = {
    ...
    'X-Requested-With': 'MLZCommunity-Plugin',
...
class HTTPClient:
    ...
    def get_binary(self, url: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        try:
            client = self._ensure_client()
            headers = self._get_cached_headers()
